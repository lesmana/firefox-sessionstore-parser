...
class ArgvParser(object):
  ...
  def prepareoptstring(self, possibleopt, argcount, argmod):
  ...
  def preparepossibleopt(self, possibleopt, argcount):
    ...
    if possibleopt.startswith('--'):
      # handle long opt
      optstring = self.prepareoptstring(possibleopt, argcount, '=')
  ...
  def prepareoptiondata(self, optiondata):
    ...
    for possibleopt in possibleopts:
      shorts, longs = self.preparepossibleopt(possibleopt, argcount)
